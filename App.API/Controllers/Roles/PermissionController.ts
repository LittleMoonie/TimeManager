...
export class PermissionController extends Controller {
  ...
  public async createPermission(
    ...
    const perm = await this.permissionService.createPermission(me.companyId, me, body);
    this.setStatus(201);
    return perm;
  }
  ...
  @Get('/')
  @Security('jwt', ['admin'])
  public async getAllPermissions(@Request() request: ExpressRequest): Promise<Permission[]> {
    const me = request.user as User;
