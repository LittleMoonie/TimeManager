...
export class TimesheetApprovalController extends Controller {
  ...
  public async createTimesheetApproval(
    ...
    return this.timesheetApprovalService.createTimesheetApproval(
      me.companyId,
      dto,
    );
  }
  ...
  public async getTimesheetApproval(
    ...
    const me = request.user as User;
    return this.timesheetApprovalService.getTimesheetApprovalById(
      me.companyId,
      id,
    );
  }
  ...
  public async updateTimesheetApproval(
    ...
    const me = request.user as User;
    return this.timesheetApprovalService.updateTimesheetApproval(
      me.companyId,
      id,
      dto,
    );
  ...
  public async deleteTimesheetApproval(
    ...
    const me = request.user as User;
    await this.timesheetApprovalService.deleteTimesheetApproval(
      me.companyId,
      id,
    );
  }
