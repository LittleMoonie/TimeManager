...
export class AppError extends BaseEntity {
  ...
  @Column({ type: 'varchar', length: 16, default: 'ERROR' }) level!: 'DEBUG'|'INFO'|'WARN'|'ERROR'|'FATAL';
  ...
  @Column({ type: 'jsonb', nullable: true }) context?: Record<string, any>; // route, params, userId, requestId, etc.
}
