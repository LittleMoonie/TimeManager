import { Column, Entity, ManyToOne, Check, Index, JoinColumn, OneToMany } from 'typeorm';
...
export enum WorkMode { OFFICE='office', REMOTE='remote', HYBRID='hybrid' }
...
export class TimesheetEntry extends BaseEntity {
  ...
  @ManyToOne(() => ActionCode, { onDelete: 'RESTRICT' }) @JoinColumn({ name: 'actionCodeId' }) actionCode!: ActionCode;

  @Column({ type: 'varchar', length: 8, default: WorkMode.OFFICE }) workMode!: WorkMode;
