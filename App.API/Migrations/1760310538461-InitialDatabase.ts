...
export class InitialDatabase1760310538461 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "action_codes" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "version" integer NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "createdByUserId" uuid, "updatedByUserId" uuid, "companyId" uuid NOT NULL, "code" character varying(255) NOT NULL, "name" character varying(255) NOT NULL, "type" character varying(16) NOT NULL DEFAULT 'billable', "active" boolean NOT NULL DEFAULT true, CONSTRAINT "UQ_cadb5135dddc76482563e8fe377" UNIQUE ("companyId", "code"), CONSTRAINT "PK_c244221d97837341650b0b6ca60" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "timesheet_entries" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "version" integer NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "createdByUserId" uuid, "updatedByUserId" uuid, "companyId" uuid NOT NULL, "userId" uuid NOT NULL, "timesheetId" uuid, "actionCodeId" uuid NOT NULL, "workMode" character varying(8) NOT NULL DEFAULT 'office', "country" character varying(2) NOT NULL, "startedAt" TIMESTAMP WITH TIME ZONE, "endedAt" TIMESTAMP WITH TIME ZONE, "durationMin" integer NOT NULL, "day" date NOT NULL, "note" text, CONSTRAINT "CHK_f43d68235bf6b726c53ed99559" CHECK ("durationMin" BETWEEN 0 AND 1440), CONSTRAINT "PK_25a8a9b6a96e72864d598563c56" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
