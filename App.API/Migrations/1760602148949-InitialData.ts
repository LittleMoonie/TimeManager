...
export class InitialData1760602148949 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX "IDX_3021b8f6838973d8ac4980c424" ON "timesheets" ("companyId", "status") `);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_7d68b6b580dee2d278730e2523" ON "timesheets" ("companyId", "userId", "periodStart", "periodEnd") `);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_3f3da1c533bf1ff4ffdb5b5b12" ON "timesheet_entries" ("timesheetRowId", "day") `);
        await queryRunner.query(`CREATE INDEX "IDX_37f742cd24094240abfefe7c73" ON "timesheet_entries" ("companyId", "timesheetId") `);
        await queryRunner.query(`CREATE INDEX "IDX_159d34ce6ffc2c05457cd13153" ON "timesheet_entries" ("companyId", "userId", "day") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_f4d20dc751e282273acfa47f57" ON "timesheet_history" ("companyId", "targetType", "targetId") `);
        await queryRunner.query(`CREATE INDEX "IDX_6268d20a72e1b18dff32f35f45" ON "timesheet_history" ("companyId", "userId") `);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_c6f2f91de84d85084a930657f1" ON "team_members" ("companyId", "teamId", "userId") `);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_966722747d5714ca0004d10881" ON "teams" ("companyId", "id", "name") `);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_45a18190352130763a12277cf6" ON "permissions" ("companyId", "name") `);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_f41f8c6c1fb5eb042d2b37a45e" ON "permissions" ("companyId", "id") `);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_4d5b34779ce0ce383408376696" ON "role_permissions" ("companyId", "roleId", "permissionId") `);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_0385fdf771296e383c90c8a201" ON "roles" ("companyId", "name") `);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_e49da5b4edf713f75a9cedbe67" ON "roles" ("companyId", "id") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_9552793858873524524e6292dc" ON "active_sessions" ("expiresAt") `);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_8a0232c472ac5fd98bc66dcfb2" ON "active_sessions" ("tokenHash") `);
        await queryRunner.query(`CREATE INDEX "IDX_428eacd8106a365cb6d504fc1f" ON "active_sessions" ("companyId", "userId") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_bfef67e9afa18541460e965129" ON "users" ("companyId", "statusId") `);
        await queryRunner.query(`CREATE INDEX "IDX_d026fb529267ddb23a759d7812" ON "users" ("companyId", "roleId") `);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_712444039e93513628513fa89a" ON "users" ("companyId", "email") `);
        await queryRunner.query(`CREATE INDEX "IDX_3792ba7ce3ee793cf55d3a308a" ON "users" ("companyId", "id") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_6cb7b102ce47a2a7062a0d2ae5" ON "leave_requests" ("companyId", "startDate", "endDate") `);
        await queryRunner.query(`CREATE INDEX "IDX_694ca8851e4e80bdd0a50020c7" ON "leave_requests" ("companyId", "userId") `);
        await queryRunner.query(`CREATE TABLE "webhook_outbox" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "version" integer NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "createdByUserId" uuid, "updatedByUserId" uuid, "companyId" uuid NOT NULL, "eventType" character varying(64) NOT NULL, "payload" jsonb NOT NULL, "status" character varying(16) NOT NULL DEFAULT 'PENDING', "attempt" integer NOT NULL DEFAULT '0', "nextAttemptAt" TIMESTAMP WITH TIME ZONE, "lastError" text, CONSTRAINT "PK_f4a40df90155b6146edea062e4b" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_3a34232c2b64dc298cf17c49d5" ON "webhook_outbox" ("companyId", "status") `);
        await queryRunner.query(`CREATE INDEX "IDX_b8b6bdf231541606d3b59f3bcb" ON "webhook_outbox" ("companyId", "eventType") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_4eb5860e3d2a3e90cc7241a76f" ON "webhook_logs" ("companyId", "event") `);
        await queryRunner.query(`CREATE INDEX "IDX_c7a67fa4e2e06c363bf26b9b09" ON "webhook_logs" ("companyId", "type") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_83f1da2c400ac70f676657ee01" ON "webhook_deliveries" ("outboxId") `);
        await queryRunner.query(`CREATE TYPE "public"."user_activity_logs_activitytype_enum" AS ENUM('CREATE_USER', 'UPDATE_USER', 'DELETE_USER', 'CHANGE_USER_STATUS', 'CREATE_ROLE', 'UPDATE_ROLE', 'DELETE_ROLE', 'ADD_PERMISSION_TO_ROLE', 'REMOVE_PERMISSION_FROM_ROLE', 'CREATE_PERMISSION', 'UPDATE_PERMISSION', 'DELETE_PERMISSION')`);
        await queryRunner.query(`CREATE TABLE "user_activity_logs" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "version" integer NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "createdByUserId" uuid, "updatedByUserId" uuid, "companyId" uuid NOT NULL, "userId" uuid NOT NULL, "activityType" "public"."user_activity_logs_activitytype_enum" NOT NULL, "targetId" uuid, "details" jsonb, CONSTRAINT "PK_8cba6ba151a9dda40181f99386a" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_9d7893a95ffdd37a8984e40f18" ON "user_activity_logs" ("companyId", "targetId") `);
        await queryRunner.query(`CREATE INDEX "IDX_3e6758ddae91d59f7f0c5d3d3e" ON "user_activity_logs" ("companyId", "activityType") `);
        await queryRunner.query(`CREATE INDEX "IDX_84f96322fea232b8f586b46a8a" ON "user_activity_logs" ("companyId", "userId") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_f891ebd989b503abac3f670c35" ON "system_logs" ("companyId", "level") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_d4a8ef94b1bcea81a569a74e68" ON "security_events" ("companyId", "subjectType", "subjectId") `);
        await queryRunner.query(`CREATE INDEX "IDX_88a0c2638a01c6dc0bfed67709" ON "security_events" ("companyId", "eventType") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_1fd4bb40f33b2bc06104d0ee3c" ON "login_attempts" ("companyId", "userId") `);
        await queryRunner.query(`CREATE INDEX "IDX_2be1809111f92ac1364fa5b251" ON "login_attempts" ("companyId", "email") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_a97590f8e08c9b3f0139261f4f" ON "email_logs" ("companyId", "toEmail") `);
        await queryRunner.query(`CREATE INDEX "IDX_5f790cb75d98ba8bb0c58468da" ON "email_logs" ("companyId", "template") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_22de6e14c6acf071b0f5b209af" ON "auth_logs" ("companyId", "action") `);
        await queryRunner.query(`CREATE INDEX "IDX_658d43fbf41939f685cd83600c" ON "auth_logs" ("companyId", "userId") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_933a6512c88fd1ff683970f4c9" ON "data_access_logs" ("companyId", "actorUserId") `);
        await queryRunner.query(`CREATE INDEX "IDX_2734a95ab9b9284d289be6a32e" ON "data_access_logs" ("companyId", "targetType", "targetId") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_e5ce1d3dc21c4ca52b8ceb5c06" ON "audit_logs" ("companyId", "actorUserId") `);
        await queryRunner.query(`CREATE INDEX "IDX_1213ae71840eb542af204cb52a" ON "audit_logs" ("companyId", "entity", "entityId") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_65046d2ba0bad86a52e9884557" ON "action_logs" ("companyId", "actionType") `);
        await queryRunner.query(`CREATE INDEX "IDX_b404e6e95fdf5bb3b9b9883ffb" ON "action_logs" ("companyId", "userId") `);
        await queryRunner.query(`ALTER TABLE "menu_category" ADD CONSTRAINT "FK_039f21d131c30add6e477fe3f4c" FOREIGN KEY ("companyId") REFERENCES "companies"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "menu_card" ADD CONSTRAINT "FK_0cf865d0cb223e8dd59ed782529" FOREIGN KEY ("companyId") REFERENCES "companies"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "menu_card" ADD CONSTRAINT "FK_35892983cb51c14c99f3507b490" FOREIGN KEY ("categoryId") REFERENCES "menu_category"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "action_codes" ADD CONSTRAINT "FK_17c0a062a623025d6b70dd81226" FOREIGN KEY ("companyId") REFERENCES "companies"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "timesheet_rows" ADD CONSTRAINT "FK_fd6760d56ff38e9ef6f9cd37700" FOREIGN KEY ("companyId") REFERENCES "companies"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "timesheet_rows" ADD CONSTRAINT "FK_8683737f56c0f6809c0d322a3df" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "timesheet_rows" ADD CONSTRAINT "FK_4a9907ebf895be0228ee29ce052" FOREIGN KEY ("timesheetId") REFERENCES "timesheets"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "timesheet_rows" ADD CONSTRAINT "FK_242ea60682a18efdef2fb90373a" FOREIGN KEY ("timeCodeId") REFERENCES "action_codes"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "timesheets" ADD CONSTRAINT "FK_89ac120b168dd4b26d4349554ff" FOREIGN KEY ("companyId") REFERENCES "companies"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "timesheets" ADD CONSTRAINT "FK_febd9f329a975672fa9a1f4448a" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "timesheet_entries" ADD CONSTRAINT "FK_380c5643e8a62add169346f1248" FOREIGN KEY ("companyId") REFERENCES "companies"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "timesheet_entries" ADD CONSTRAINT "FK_013f4b223291c19dd0cfbe8b486" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "timesheet_entries" ADD CONSTRAINT "FK_2d6af47ea3d0f717cbd72aaf83c" FOREIGN KEY ("timesheetId") REFERENCES "timesheets"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "timesheet_entries" ADD CONSTRAINT "FK_2fcd37fedc8e13cffc8555ee4d5" FOREIGN KEY ("timesheetRowId") REFERENCES "timesheet_rows"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "timesheet_entries" ADD CONSTRAINT "FK_9f9e9227c677ff05786dbde0902" FOREIGN KEY ("actionCodeId") REFERENCES "action_codes"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "timesheet_history" ADD CONSTRAINT "FK_ca26a76210c39184513b8407acc" FOREIGN KEY ("companyId") REFERENCES "companies"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "team_members" ADD CONSTRAINT "FK_6d1c8c7f705803f0711336a5c33" FOREIGN KEY ("teamId") REFERENCES "teams"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "team_members" ADD CONSTRAINT "FK_0a72b849753a046462b4c5a8ec2" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "permissions" ADD CONSTRAINT "FK_e888ff0ee7bd00c3771a9efe360" FOREIGN KEY ("companyId") REFERENCES "companies"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "role_permissions" ADD CONSTRAINT "FK_213a7c67a32942a93a1f945a412" FOREIGN KEY ("companyId") REFERENCES "companies"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "role_permissions" ADD CONSTRAINT "FK_014b2fcda5716d8c15e80fd49ee" FOREIGN KEY ("roleId", "companyId") REFERENCES "roles"("id","companyId") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "role_permissions" ADD CONSTRAINT "FK_c7769bcf3bbc2f66e4a37a821c3" FOREIGN KEY ("permissionId", "companyId") REFERENCES "permissions"("id","companyId") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "active_sessions" ADD CONSTRAINT "FK_5629b436a4b1ff80ef886aaaead" FOREIGN KEY ("companyId") REFERENCES "companies"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "active_sessions" ADD CONSTRAINT "FK_be166928edf8fd4aa5281078f13" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "users" ADD CONSTRAINT "FK_d026fb529267ddb23a759d78129" FOREIGN KEY ("roleId", "companyId") REFERENCES "roles"("id","companyId") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "users" ADD CONSTRAINT "FK_fffa7945e50138103659f6326b7" FOREIGN KEY ("statusId") REFERENCES "user_statuses"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "timesheet_approvals" ADD CONSTRAINT "FK_6b3b90451dd4c7f77171fe70ade" FOREIGN KEY ("companyId") REFERENCES "companies"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "timesheet_approvals" ADD CONSTRAINT "FK_67b89eba823d219dbc3d68b133f" FOREIGN KEY ("timesheetId") REFERENCES "timesheets"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "timesheet_approvals" ADD CONSTRAINT "FK_d91d706b145d7d465076fda498f" FOREIGN KEY ("approverId") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "leave_requests" ADD CONSTRAINT "FK_376c8ef3cabe68437bc0de9cf33" FOREIGN KEY ("companyId") REFERENCES "companies"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "leave_requests" ADD CONSTRAINT "FK_0cd010879e155a6611f00dc456e" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "webhook_outbox" ADD CONSTRAINT "FK_e8f08024c92c93711ac323647de" FOREIGN KEY ("companyId") REFERENCES "companies"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "webhook_logs" ADD CONSTRAINT "FK_d4d957bccdf2479c89ff8e0efa0" FOREIGN KEY ("companyId") REFERENCES "companies"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "webhook_deliveries" ADD CONSTRAINT "FK_83f1da2c400ac70f676657ee01d" FOREIGN KEY ("outboxId") REFERENCES "webhook_outbox"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "user_activity_logs" ADD CONSTRAINT "FK_6392c5d14e7a70a7f41a282b0d3" FOREIGN KEY ("companyId") REFERENCES "companies"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "user_activity_logs" ADD CONSTRAINT "FK_348e9272a0e84920c9d3d52ffd8" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "system_logs" ADD CONSTRAINT "FK_645cf4a374c39d514de3408c4cd" FOREIGN KEY ("companyId") REFERENCES "companies"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "security_events" ADD CONSTRAINT "FK_e0c789ed7790c076ae5e6c4607c" FOREIGN KEY ("companyId") REFERENCES "companies"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "security_events" ADD CONSTRAINT "FK_6df120f11ca99d43c2e1640bb39" FOREIGN KEY ("actorUserId") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "auth_logs" ADD CONSTRAINT "FK_8d6bffc0a2a6c6c0272f93ebe47" FOREIGN KEY ("companyId") REFERENCES "companies"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "auth_logs" ADD CONSTRAINT "FK_564498ad3b1e8e338de48222381" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "error_logs" ADD CONSTRAINT "FK_97dc05895caf6aa993d5590b439" FOREIGN KEY ("companyId") REFERENCES "companies"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "error_logs" ADD CONSTRAINT "FK_93172909565ba6cf0d3d8314dff" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "data_logs" ADD CONSTRAINT "FK_bbe480248bee00fad69af4c19ea" FOREIGN KEY ("companyId") REFERENCES "companies"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "data_logs" ADD CONSTRAINT "FK_06f2c126041ecc55d3d085bb8be" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "data_access_logs" ADD CONSTRAINT "FK_e78343ba16619f728e192dcfb17" FOREIGN KEY ("companyId") REFERENCES "companies"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "data_access_logs" ADD CONSTRAINT "FK_40d2592cf4943d6d0ac944e6ba6" FOREIGN KEY ("actorUserId") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "audit_logs" ADD CONSTRAINT "FK_efa597fecfef3d3ec683d693324" FOREIGN KEY ("companyId") REFERENCES "companies"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "action_logs" ADD CONSTRAINT "FK_89921ef56ca1d237cf174333cf2" FOREIGN KEY ("companyId") REFERENCES "companies"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "action_logs" ADD CONSTRAINT "FK_de319bbd28a51b275eb155b1302" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "action_logs" DROP CONSTRAINT "FK_de319bbd28a51b275eb155b1302"`);
        await queryRunner.query(`ALTER TABLE "action_logs" DROP CONSTRAINT "FK_89921ef56ca1d237cf174333cf2"`);
        ...
        await queryRunner.query(`ALTER TABLE "data_access_logs" DROP CONSTRAINT "FK_40d2592cf4943d6d0ac944e6ba6"`);
        await queryRunner.query(`ALTER TABLE "data_access_logs" DROP CONSTRAINT "FK_e78343ba16619f728e192dcfb17"`);
        await queryRunner.query(`ALTER TABLE "data_logs" DROP CONSTRAINT "FK_06f2c126041ecc55d3d085bb8be"`);
        await queryRunner.query(`ALTER TABLE "data_logs" DROP CONSTRAINT "FK_bbe480248bee00fad69af4c19ea"`);
        await queryRunner.query(`ALTER TABLE "error_logs" DROP CONSTRAINT "FK_93172909565ba6cf0d3d8314dff"`);
        await queryRunner.query(`ALTER TABLE "error_logs" DROP CONSTRAINT "FK_97dc05895caf6aa993d5590b439"`);
        await queryRunner.query(`ALTER TABLE "auth_logs" DROP CONSTRAINT "FK_564498ad3b1e8e338de48222381"`);
        await queryRunner.query(`ALTER TABLE "auth_logs" DROP CONSTRAINT "FK_8d6bffc0a2a6c6c0272f93ebe47"`);
        await queryRunner.query(`ALTER TABLE "security_events" DROP CONSTRAINT "FK_6df120f11ca99d43c2e1640bb39"`);
        await queryRunner.query(`ALTER TABLE "security_events" DROP CONSTRAINT "FK_e0c789ed7790c076ae5e6c4607c"`);
        await queryRunner.query(`ALTER TABLE "system_logs" DROP CONSTRAINT "FK_645cf4a374c39d514de3408c4cd"`);
        await queryRunner.query(`ALTER TABLE "user_activity_logs" DROP CONSTRAINT "FK_348e9272a0e84920c9d3d52ffd8"`);
        await queryRunner.query(`ALTER TABLE "user_activity_logs" DROP CONSTRAINT "FK_6392c5d14e7a70a7f41a282b0d3"`);
        await queryRunner.query(`ALTER TABLE "webhook_deliveries" DROP CONSTRAINT "FK_83f1da2c400ac70f676657ee01d"`);
        await queryRunner.query(`ALTER TABLE "webhook_logs" DROP CONSTRAINT "FK_d4d957bccdf2479c89ff8e0efa0"`);
        await queryRunner.query(`ALTER TABLE "webhook_outbox" DROP CONSTRAINT "FK_e8f08024c92c93711ac323647de"`);
        await queryRunner.query(`ALTER TABLE "leave_requests" DROP CONSTRAINT "FK_0cd010879e155a6611f00dc456e"`);
        await queryRunner.query(`ALTER TABLE "leave_requests" DROP CONSTRAINT "FK_376c8ef3cabe68437bc0de9cf33"`);
        await queryRunner.query(`ALTER TABLE "timesheet_approvals" DROP CONSTRAINT "FK_d91d706b145d7d465076fda498f"`);
        await queryRunner.query(`ALTER TABLE "timesheet_approvals" DROP CONSTRAINT "FK_67b89eba823d219dbc3d68b133f"`);
        await queryRunner.query(`ALTER TABLE "timesheet_approvals" DROP CONSTRAINT "FK_6b3b90451dd4c7f77171fe70ade"`);
        ...
        await queryRunner.query(`ALTER TABLE "active_sessions" DROP CONSTRAINT "FK_be166928edf8fd4aa5281078f13"`);
        await queryRunner.query(`ALTER TABLE "active_sessions" DROP CONSTRAINT "FK_5629b436a4b1ff80ef886aaaead"`);
        await queryRunner.query(`ALTER TABLE "roles" DROP CONSTRAINT "FK_5ff67a53e3777f7ab6186db44ba"`);
        await queryRunner.query(`ALTER TABLE "role_permissions" DROP CONSTRAINT "FK_c7769bcf3bbc2f66e4a37a821c3"`);
        await queryRunner.query(`ALTER TABLE "role_permissions" DROP CONSTRAINT "FK_014b2fcda5716d8c15e80fd49ee"`);
        await queryRunner.query(`ALTER TABLE "role_permissions" DROP CONSTRAINT "FK_213a7c67a32942a93a1f945a412"`);
        await queryRunner.query(`ALTER TABLE "permissions" DROP CONSTRAINT "FK_e888ff0ee7bd00c3771a9efe360"`);
        ...
        await queryRunner.query(`ALTER TABLE "timesheet_history" DROP CONSTRAINT "FK_ca26a76210c39184513b8407acc"`);
        await queryRunner.query(`ALTER TABLE "timesheet_entries" DROP CONSTRAINT "FK_9f9e9227c677ff05786dbde0902"`);
        await queryRunner.query(`ALTER TABLE "timesheet_entries" DROP CONSTRAINT "FK_2fcd37fedc8e13cffc8555ee4d5"`);
        ...
        await queryRunner.query(`ALTER TABLE "timesheet_entries" DROP CONSTRAINT "FK_380c5643e8a62add169346f1248"`);
        await queryRunner.query(`ALTER TABLE "timesheets" DROP CONSTRAINT "FK_febd9f329a975672fa9a1f4448a"`);
        await queryRunner.query(`ALTER TABLE "timesheets" DROP CONSTRAINT "FK_89ac120b168dd4b26d4349554ff"`);
        await queryRunner.query(`ALTER TABLE "timesheet_rows" DROP CONSTRAINT "FK_242ea60682a18efdef2fb90373a"`);
        await queryRunner.query(`ALTER TABLE "timesheet_rows" DROP CONSTRAINT "FK_4a9907ebf895be0228ee29ce052"`);
        await queryRunner.query(`ALTER TABLE "timesheet_rows" DROP CONSTRAINT "FK_8683737f56c0f6809c0d322a3df"`);
        await queryRunner.query(`ALTER TABLE "timesheet_rows" DROP CONSTRAINT "FK_fd6760d56ff38e9ef6f9cd37700"`);
        await queryRunner.query(`ALTER TABLE "action_codes" DROP CONSTRAINT "FK_17c0a062a623025d6b70dd81226"`);
        await queryRunner.query(`ALTER TABLE "menu_card" DROP CONSTRAINT "FK_35892983cb51c14c99f3507b490"`);
        await queryRunner.query(`ALTER TABLE "menu_card" DROP CONSTRAINT "FK_0cf865d0cb223e8dd59ed782529"`);
        await queryRunner.query(`ALTER TABLE "menu_category" DROP CONSTRAINT "FK_039f21d131c30add6e477fe3f4c"`);
