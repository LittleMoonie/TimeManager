...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        ...
        const argsPermissionController_createPermission: Record<string, TsoaRoute.ParameterSchema> = {
                requestBody: {"in":"body","name":"requestBody","required":true,"ref":"CreatePermissionDto"},
                request: {"in":"request","name":"request","required":true,"dataType":"object"},
        };
        ...
        const argsPermissionController_updatePermission: Record<string, TsoaRoute.ParameterSchema> = {
                id: {"in":"path","name":"id","required":true,"dataType":"string"},
                requestBody: {"in":"body","name":"requestBody","required":true,"ref":"UpdatePermissionDto"},
                request: {"in":"request","name":"request","required":true,"dataType":"object"},
        };
        ...
        const argsRoleController_createRole: Record<string, TsoaRoute.ParameterSchema> = {
                requestBody: {"in":"body","name":"requestBody","required":true,"ref":"CreateRoleDto"},
                request: {"in":"request","name":"request","required":true,"dataType":"object"},
        };
        app.post('/roles',
            authenticateMiddleware([{"jwt":["admin"]}]),
        ...
        const argsRoleController_updateRole: Record<string, TsoaRoute.ParameterSchema> = {
                id: {"in":"path","name":"id","required":true,"dataType":"string"},
                requestBody: {"in":"body","name":"requestBody","required":true,"ref":"UpdateRoleDto"},
                request: {"in":"request","name":"request","required":true,"dataType":"object"},
        };
        app.put('/roles/:id',
            authenticateMiddleware([{"jwt":["admin"]}]),
        ...
        const argsTimesheetController_createTimesheet: Record<string, TsoaRoute.ParameterSchema> = {
                createTimesheetDto: {"in":"body","name":"createTimesheetDto","required":true,"ref":"CreateTimesheetDto"},
                request: {"in":"request","name":"request","required":true,"dataType":"object"},
        };
        app.post('/timesheets',
            authenticateMiddleware([{"jwt":[]}]),
        ...
        const argsTimesheetController_addTimesheetEntry: Record<string, TsoaRoute.ParameterSchema> = {
                id: {"in":"path","name":"id","required":true,"dataType":"string"},
                createTimesheetEntryDto: {"in":"body","name":"createTimesheetEntryDto","required":true,"ref":"CreateTimesheetEntryDto"},
                request: {"in":"request","name":"request","required":true,"dataType":"object"},
        };
        ...
        const argsTimesheetApprovalController_createTimesheetApproval: Record<string, TsoaRoute.ParameterSchema> = {
                createTimesheetApprovalDto: {"in":"body","name":"createTimesheetApprovalDto","required":true,"ref":"CreateTimesheetApprovalDto"},
                request: {"in":"request","name":"request","required":true,"dataType":"object"},
        };
        ...
        const argsTimesheetApprovalController_updateTimesheetApproval: Record<string, TsoaRoute.ParameterSchema> = {
                id: {"in":"path","name":"id","required":true,"dataType":"string"},
                updateTimesheetApprovalDto: {"in":"body","name":"updateTimesheetApprovalDto","required":true,"ref":"UpdateTimesheetApprovalDto"},
                request: {"in":"request","name":"request","required":true,"dataType":"object"},
        };
        ...
        const argsTimesheetEntryController_updateTimesheetEntry: Record<string, TsoaRoute.ParameterSchema> = {
                id: {"in":"path","name":"id","required":true,"dataType":"string"},
                updateTimesheetEntryDto: {"in":"body","name":"updateTimesheetEntryDto","required":true,"ref":"UpdateTimesheetEntryDto"},
                request: {"in":"request","name":"request","required":true,"dataType":"object"},
        };
        ...
        const argsTimesheetHistoryController_listHistory: Record<string, TsoaRoute.ParameterSchema> = {
                request: {"in":"request","name":"request","required":true,"dataType":"object"},
                body: {"in":"body","name":"body","required":true,"ref":"TimesheetHistoryResponseDto"},
        };
        ...
        const argsRolePermissionController_createRolePermission: Record<string, TsoaRoute.ParameterSchema> = {
                createRolePermissionDto: {"in":"body","name":"createRolePermissionDto","required":true,"ref":"CreateRolePermissionDto"},
                request: {"in":"request","name":"request","required":true,"dataType":"object"},
        };
        ...
        const argsUserStatusController_createUserStatus: Record<string, TsoaRoute.ParameterSchema> = {
                createUserStatusDto: {"in":"body","name":"createUserStatusDto","required":true,"ref":"CreateUserStatusDto"},
                request: {"in":"request","name":"request","required":true,"dataType":"object"},
        };
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        const argsUserStatusController_getAllUserStatuses: Record<string, TsoaRoute.ParameterSchema> = {
                request: {"in":"request","name":"request","required":true,"dataType":"object"},
        };
        app.get('/user-statuses',
            authenticateMiddleware([{"jwt":[]}]),
            ...(fetchMiddlewares<RequestHandler>(UserStatusController)),
            ...(fetchMiddlewares<RequestHandler>(UserStatusController.prototype.getAllUserStatuses)),

            async function UserStatusController_getAllUserStatuses(request: ExRequest, response: ExResponse, next: any) {
        ...
        const argsUserStatusController_updateUserStatus: Record<string, TsoaRoute.ParameterSchema> = {
                id: {"in":"path","name":"id","required":true,"dataType":"string"},
                updateUserStatusDto: {"in":"body","name":"updateUserStatusDto","required":true,"ref":"UpdateUserStatusDto"},
                request: {"in":"request","name":"request","required":true,"dataType":"object"},
        };
