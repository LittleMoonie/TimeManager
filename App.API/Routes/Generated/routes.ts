...
const models: TsoaRoute.Models = {
  ...
  TimesheetWeekRowDto: {
    ...
    properties: {
      ...
      entries: {
        dataType: 'array',
        array: { dataType: 'refObject', ref: 'TimesheetWeekRowEntryDto' },
        required: true,
      },
  ...
  TimesheetWeekResponseDto: {
    ...
    properties: {
      ...
      rows: {
        dataType: 'array',
        array: { dataType: 'refObject', ref: 'TimesheetWeekRowDto' },
        required: true,
      },
  ...
  Timesheet: {
    ...
    properties: {
      ...
      rows: {
        dataType: 'array',
        array: { dataType: 'refObject', ref: 'TimesheetRow' },
        required: true,
      },
    },
    additionalProperties: false,
...
export function RegisterRoutes(app: Router) {
  ...
  app.get(
    ...
    async function ActiveSessionsController_getAllUserSessions(
      ...
      try {
        ...
        const controller: any =
          await container.get<ActiveSessionsController>(ActiveSessionsController);
        if (typeof controller['setStatus'] === 'function') {
          controller.setStatus(undefined);
        }
  ...
  app.get(
    '/timesheet/weeks/:weekStart/timesheet',
    authenticateMiddleware([{ jwt: [] }]),
    ...
    async function TimesheetWeekController_getWeekTimesheet(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsTimesheetWeekController_getWeekTimesheet,
          request,
          response,
        });
        ...
        const controller: any =
          await container.get<TimesheetWeekController>(TimesheetWeekController);
        if (typeof controller['setStatus'] === 'function') {
          controller.setStatus(undefined);
        }
  ...
  app.put(
    ...
    async function TimesheetWeekController_upsertWeekTimesheet(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsTimesheetWeekController_upsertWeekTimesheet,
          request,
          response,
        });
  ...
  app.post(
    '/timesheet/weeks/:weekStart/submit',
    authenticateMiddleware([{ jwt: [] }]),
    ...fetchMiddlewares<RequestHandler>(TimesheetWeekController),
    ...fetchMiddlewares<RequestHandler>(TimesheetWeekController.prototype.submitWeekTimesheet),

    async function TimesheetWeekController_submitWeekTimesheet(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsTimesheetWeekController_submitWeekTimesheet,
          request,
          response,
        });
  ...
  app.post(
    ...
    async function TimesheetEntryController_createTimesheetEntry(
      ...
      try {
        ...
        const controller: any =
          await container.get<TimesheetEntryController>(TimesheetEntryController);
        if (typeof controller['setStatus'] === 'function') {
          controller.setStatus(undefined);
        }
  ...
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  const argsTimesheetEntryController_submitTimesheetEntry: Record<
    string,
    TsoaRoute.ParameterSchema
  > = {
    id: { in: 'path', name: 'id', required: true, dataType: 'string' },
  ...
  app.put(
    '/timesheet-entries/:id/submit',
    authenticateMiddleware([{ jwt: [] }]),
    ...fetchMiddlewares<RequestHandler>(TimesheetEntryController),
    ...fetchMiddlewares<RequestHandler>(TimesheetEntryController.prototype.submitTimesheetEntry),

    async function TimesheetEntryController_submitTimesheetEntry(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsTimesheetEntryController_submitTimesheetEntry,
          request,
          response,
        });
  ...
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  const argsTimesheetEntryController_approveTimesheetEntry: Record<
    string,
    TsoaRoute.ParameterSchema
  > = {
    id: { in: 'path', name: 'id', required: true, dataType: 'string' },
  ...
  app.put(
    '/timesheet-entries/:id/approve',
    authenticateMiddleware([{ jwt: [] }]),
    ...fetchMiddlewares<RequestHandler>(TimesheetEntryController),
    ...fetchMiddlewares<RequestHandler>(TimesheetEntryController.prototype.approveTimesheetEntry),

    async function TimesheetEntryController_approveTimesheetEntry(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsTimesheetEntryController_approveTimesheetEntry,
          request,
          response,
        });
  ...
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  const argsTimesheetEntryController_rejectTimesheetEntry: Record<
    string,
    TsoaRoute.ParameterSchema
  > = {
    id: { in: 'path', name: 'id', required: true, dataType: 'string' },
  ...
  app.put(
    '/timesheet-entries/:id/reject',
    authenticateMiddleware([{ jwt: [] }]),
    ...fetchMiddlewares<RequestHandler>(TimesheetEntryController),
    ...fetchMiddlewares<RequestHandler>(TimesheetEntryController.prototype.rejectTimesheetEntry),

    async function TimesheetEntryController_rejectTimesheetEntry(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsTimesheetEntryController_rejectTimesheetEntry,
          request,
          response,
        });
  ...
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  const argsTimesheetEntryController_invoiceTimesheetEntry: Record<
    string,
    TsoaRoute.ParameterSchema
  > = {
    id: { in: 'path', name: 'id', required: true, dataType: 'string' },
  ...
  app.put(
    '/timesheet-entries/:id/invoice',
    authenticateMiddleware([{ jwt: [] }]),
    ...fetchMiddlewares<RequestHandler>(TimesheetEntryController),
    ...fetchMiddlewares<RequestHandler>(TimesheetEntryController.prototype.invoiceTimesheetEntry),

    async function TimesheetEntryController_invoiceTimesheetEntry(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsTimesheetEntryController_invoiceTimesheetEntry,
          request,
          response,
        });
  ...
  app.post(
    ...
    async function TimesheetApprovalController_createTimesheetApproval(
      ...
      try {
        ...
        const controller: any = await container.get<TimesheetApprovalController>(
  ...
  app.get(
    ...
    async function ActionCodeCategoryController_getAll(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsActionCodeCategoryController_getAll,
          request,
          response,
        });
        ...
        const controller: any = await container.get<ActionCodeCategoryController>(
          ActionCodeCategoryController,
        );
        if (typeof controller['setStatus'] === 'function') {
          controller.setStatus(undefined);
        }
  ...
  app.get(
    ...
    async function ActionCodeCategoryController_getById(
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsActionCodeCategoryController_getById,
          request,
          response,
        });
  ...
  app.post(
    ...
    async function ActionCodeCategoryController_create(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsActionCodeCategoryController_create,
          request,
          response,
        });
  ...
  app.put(
    ...
    async function ActionCodeCategoryController_update(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsActionCodeCategoryController_update,
          request,
          response,
        });
  ...
  app.delete(
    ...
    async function ActionCodeCategoryController_delete(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsActionCodeCategoryController_delete,
          request,
          response,
        });
  ...
  app.post(
    ...
    async function RolePermissionController_createRolePermission(
      ...
      try {
        ...
        const controller: any =
          await container.get<RolePermissionController>(RolePermissionController);
        if (typeof controller['setStatus'] === 'function') {
          controller.setStatus(undefined);
        }
  ...
  app.post(
    ...
    async function LeaveRequestController_createLeaveRequest(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsLeaveRequestController_createLeaveRequest,
          request,
          response,
        });
  ...
  app.get(
    ...
    async function LeaveRequestController_getLeaveRequest(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsLeaveRequestController_getLeaveRequest,
          request,
          response,
        });
  ...
  app.get(
    ...
    async function LeaveRequestController_getAllLeaveRequests(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsLeaveRequestController_getAllLeaveRequests,
          request,
          response,
        });
  ...
  app.put(
    ...
    async function LeaveRequestController_updateLeaveRequest(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsLeaveRequestController_updateLeaveRequest,
          request,
          response,
        });
  ...
  app.delete(
    ...
    async function LeaveRequestController_deleteLeaveRequest(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsLeaveRequestController_deleteLeaveRequest,
          request,
          response,
        });
  ...
  app.get(
    ...
    async function CompanySettingsController_getCompanySettings(
      ...
      try {
        ...
        const controller: any =
          await container.get<CompanySettingsController>(CompanySettingsController);
        if (typeof controller['setStatus'] === 'function') {
          controller.setStatus(undefined);
        }
  ...
  app.get(
    ...
    async function CompanyCountryController_listCountries(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsCompanyCountryController_listCountries,
          request,
          response,
        });
        ...
        const controller: any =
          await container.get<CompanyCountryController>(CompanyCountryController);
        if (typeof controller['setStatus'] === 'function') {
          controller.setStatus(undefined);
        }
  ...
  app.post(
    ...
    async function AuthenticationController_register(
      ...
      try {
        ...
        const controller: any =
          await container.get<AuthenticationController>(AuthenticationController);
        if (typeof controller['setStatus'] === 'function') {
          controller.setStatus(undefined);
        }
