...
const models: TsoaRoute.Models = {
  ...
  Company: {
    ...
    properties: {
      ...
      teams: {
        dataType: "array",
        array: { dataType: "refObject", ref: "Team" },
        required: true,
      },
      actionCodes: {
        dataType: "array",
...
export function RegisterRoutes(app: Router) {
  ...
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  const argsLeaveRequestController_createLeaveRequest: Record<
    string,
    TsoaRoute.ParameterSchema
  > = {
    createLeaveRequestDto: {
  ...
  app.post(
    ...
    ...fetchMiddlewares<RequestHandler>(
      LeaveRequestController.prototype.createLeaveRequest,
    ),
    ...
    async function LeaveRequestController_createLeaveRequest(
      ...
      try {
        ...
        const controller: any = await container.get<LeaveRequestController>(
  ...
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  const argsLeaveRequestController_getLeaveRequest: Record<
    string,
    TsoaRoute.ParameterSchema
  > = {
    id: { in: "path", name: "id", required: true, dataType: "string" },
  ...
  app.get(
    ...
    ...fetchMiddlewares<RequestHandler>(LeaveRequestController),
    ...fetchMiddlewares<RequestHandler>(
      LeaveRequestController.prototype.getLeaveRequest,
    ),
  ...
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  const argsLeaveRequestController_getAllLeaveRequests: Record<
    string,
    TsoaRoute.ParameterSchema
  > = {
    request: {
  ...
  app.get(
    ...
    ...fetchMiddlewares<RequestHandler>(LeaveRequestController),
    ...fetchMiddlewares<RequestHandler>(
      LeaveRequestController.prototype.getAllLeaveRequests,
    ),
  ...
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  const argsLeaveRequestController_updateLeaveRequest: Record<
    string,
    TsoaRoute.ParameterSchema
  > = {
    id: { in: "path", name: "id", required: true, dataType: "string" },
  ...
  app.put(
    ...
    ...fetchMiddlewares<RequestHandler>(LeaveRequestController),
    ...fetchMiddlewares<RequestHandler>(
      LeaveRequestController.prototype.updateLeaveRequest,
    ),
  ...
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  const argsLeaveRequestController_deleteLeaveRequest: Record<
    string,
    TsoaRoute.ParameterSchema
  > = {
    id: { in: "path", name: "id", required: true, dataType: "string" },
  ...
  app.delete(
    ...
    ...fetchMiddlewares<RequestHandler>(LeaveRequestController),
    ...fetchMiddlewares<RequestHandler>(
      LeaveRequestController.prototype.deleteLeaveRequest,
    ),
