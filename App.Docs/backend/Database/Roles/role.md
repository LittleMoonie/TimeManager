...
The `Role` entity defines a user role within a company, encapsulating a set of permissions that dictate what actions users assigned to this role can perform. It is a fundamental component of the Role-Based Access Control (RBAC) system, enabling granular control over user privileges.

This entity is defined in `App.API/Entities/Roles/Role.ts`.
